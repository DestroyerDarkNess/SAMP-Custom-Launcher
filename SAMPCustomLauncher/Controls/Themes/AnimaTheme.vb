...
Public Class AnimaContextMenuStrip
    ...
    Private _ColorBack As Color = Color.FromArgb(28, 28, 28)
    ...
    Private Sub Renderer_PaintMenuBackground(sender As Object, e As ToolStripRenderEventArgs)
        ...
        G.Clear(_ColorBack) 'Color.FromArgb(55, 55, 58)
    End Sub
...
Public Class AnimaStatusBar
    ...
    Private _ColorBackground As Color
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using Background As New SolidBrush(_ColorBackground), Line As New Pen(_ColorBackground) 'Body 'Outline
            G.FillRectangle(Background, New Rectangle(0, 0, Width - 1, Height - 1))
