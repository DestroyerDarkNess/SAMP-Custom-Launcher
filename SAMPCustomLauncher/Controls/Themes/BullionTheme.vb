...
Class BullionSeperator
    ...
    Private _BackGj As Color = Color.FromArgb(28, 28, 28)
    Public Property ColorBackg() As Color
        Get
            Return _BackGj
        End Get
    ...
    Dim C1 As Color = _BackGj
    Dim P1, P2 As Pen
    Sub New()
        SetStyle(ControlStyles.AllPaintingInWmPaint Or ControlStyles.UserPaint, True)
        C1 = _BackGj ' Color.FromArgb(28, 28, 28) 'Background
