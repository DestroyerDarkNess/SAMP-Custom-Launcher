...
MustInherit Class ThemeContainer154Metro
...
#End Region
    ...
    Protected Overrides Sub OnHandleDestroyed(ByVal e As EventArgs)
        ThemeShareMetro.RemoveAnimationCallback(AddressOf DoAnimation)
...
#Region " Property Helpers "
    ...
    Private Sub InvalidateTimer()
        ...
        If _IsAnimated Then
            ThemeShareMetro.AddAnimationCallback(AddressOf DoAnimation)
        Else
            ThemeShareMetro.RemoveAnimationCallback(AddressOf DoAnimation)
        End If
    End Sub
...
MustInherit Class ThemeControl154Metro
    Inherits Control
